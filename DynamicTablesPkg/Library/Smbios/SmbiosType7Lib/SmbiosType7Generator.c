  ...
  )
{
  ...
  *Table = NULL;
  ...
  for (Index = 0; Index < NumCacheTable; Index++) {
    ...
    CopyMem (
      &SmbiosRecord->MaximumCacheSize,
      &CacheInfo[Index].MaximumCacheSize,
      sizeof (SmbiosRecord->MaximumCacheSize)
      );
    CopyMem (
      &SmbiosRecord->InstalledSize,
      &CacheInfo[Index].InstalledSize,
      sizeof (SmbiosRecord->InstalledSize)
      );
    ...
    CopyMem (
      &SmbiosRecord->MaximumCacheSize2,
      &CacheInfo[Index].MaximumCacheSize2,
      sizeof (SmbiosRecord->MaximumCacheSize2)
      );
    CopyMem (
      &SmbiosRecord->InstalledSize2,
      &CacheInfo[Index].InstalledSize2,
      sizeof (SmbiosRecord->InstalledSize2)
      );
    //
    // Setup SMBIOS header
    //
