...
AddGenericTimerInfo (
  ...
  IN        EFI_ACPI_6_6_GENERIC_TIMER_DESCRIPTION_TABLE *CONST  Gtdt,
...
{
  EFI_ACPI_6_6_GTDT_ARM_GENERIC_WATCHDOG_STRUCTURE  *Watchdog;

  ASSERT (Gtdt != NULL);
  ASSERT (WatchdogInfoList != NULL);

  Watchdog = (EFI_ACPI_6_6_GTDT_ARM_GENERIC_WATCHDOG_STRUCTURE *)
             ((UINT8 *)Gtdt + WatchdogOffset);

  while (WatchdogCount-- != 0) {
    // Add watchdog entry
    DEBUG ((DEBUG_INFO, "GTDT: Watchdog = 0x%p\n", Watchdog));
    Watchdog->Type   = EFI_ACPI_6_6_GTDT_ARM_GENERIC_WATCHDOG;
    Watchdog->Length =
      sizeof (EFI_ACPI_6_6_GTDT_ARM_GENERIC_WATCHDOG_STRUCTURE);
...
AddGTBlockTimerFrames (
  IN       EFI_ACPI_6_6_GTDT_GT_BLOCK_TIMER_STRUCTURE  *GtBlockFrame,
...
{
  EFI_STATUS                                  Status;
  EFI_ACPI_6_6_GTDT_GT_BLOCK_STRUCTURE        *GTBlock;
  EFI_ACPI_6_6_GTDT_GT_BLOCK_TIMER_STRUCTURE  *GtBlockFrame;
  ...
  GTBlock = (EFI_ACPI_6_6_GTDT_GT_BLOCK_STRUCTURE *)((UINT8 *)Gtdt +
                                                     GTBlockOffset);
  ...
  while (BlockTimerCount-- != 0) {
    ...
    Length = sizeof (EFI_ACPI_6_6_GTDT_GT_BLOCK_STRUCTURE) +
             (sizeof (EFI_ACPI_6_6_GTDT_GT_BLOCK_TIMER_STRUCTURE) *
    ...
    GTBlock->Type               = EFI_ACPI_6_6_GTDT_GT_BLOCK;
    ...
    GTBlock->GTBlockTimerOffset =
      sizeof (EFI_ACPI_6_6_GTDT_GT_BLOCK_STRUCTURE);

    GtBlockFrame = (EFI_ACPI_6_6_GTDT_GT_BLOCK_TIMER_STRUCTURE *)
    ...
    // Next GTBlock
    GTBlock = (EFI_ACPI_6_6_GTDT_GT_BLOCK_STRUCTURE *)((UINT8 *)GTBlock +
                                                       GTBlock->Length);
    GTBlockInfo++;
  }// for
  ...
  )
{
  ...
  EFI_ACPI_6_6_GENERIC_TIMER_DESCRIPTION_TABLE  *Gtdt;
  UINT32                                        Idx;
  ...
  *Table = NULL;
  ...
  TableSize          = sizeof (EFI_ACPI_6_6_GENERIC_TIMER_DESCRIPTION_TABLE);
  if (BlockTimerCount != 0) {
    GTBlockOffset       = TableSize;
    PlatformTimerCount += BlockTimerCount;
    TableSize          += (sizeof (EFI_ACPI_6_6_GTDT_GT_BLOCK_STRUCTURE) *
                           BlockTimerCount);
    ...
    for (Idx = 0; Idx < BlockTimerCount; Idx++) {
      ...
      TableSize += (sizeof (EFI_ACPI_6_6_GTDT_GT_BLOCK_TIMER_STRUCTURE) *
                    GTBlockInfo[Idx].GTBlockTimerFrameCount);
    }
  ...
  if (WatchdogCount != 0) {
    ...
    TableSize          += (sizeof (EFI_ACPI_6_6_GTDT_ARM_GENERIC_WATCHDOG_STRUCTURE) *
                           WatchdogCount);
    DEBUG ((
      DEBUG_INFO,
  ...
  *Table = (EFI_ACPI_DESCRIPTION_HEADER *)AllocateZeroPool (TableSize);
  ...
  Gtdt = (EFI_ACPI_6_6_GENERIC_TIMER_DESCRIPTION_TABLE *)*Table;
  DEBUG ((
    DEBUG_INFO,
