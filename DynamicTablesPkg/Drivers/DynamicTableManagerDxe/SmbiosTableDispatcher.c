...
SMBIOS_TABLE_DISPATCHER  mSmBiosDispatcher[MAX_SMBIOS_TABLES] = {
  ...
  SMBIOS_TABLE_DEP (SMBIOS_TYPE_FIRMWARE_INVENTORY_INFORMATION,       SMBIOS_TYPE_SYSTEM_SLOTS,                   SMBIOS_TYPE_ONBOARD_DEVICES_EXTENDED_INFORMATION, SMBIOS_TYPE_TPM_DEVICE,                     SMTT_NULL, SMTT_NULL),
