...
)
{
  ...
  return (EFI_STATUS)CS_To_ServiceRoot_V1_13_0_JSON (*((EFI_REDFISH_SERVICEROOT_V1_13_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
