...
)
{
  ...
  return (EFI_STATUS)CS_To_ComputerSystemCollection_JSON (*((EFI_REDFISH_COMPUTERSYSTEMCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
