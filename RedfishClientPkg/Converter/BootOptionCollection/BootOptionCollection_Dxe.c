...
)
{
  ...
  return (EFI_STATUS)CS_To_BootOptionCollection_JSON (*((EFI_REDFISH_BOOTOPTIONCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
