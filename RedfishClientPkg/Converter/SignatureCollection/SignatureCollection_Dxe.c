...
)
{
  ...
  return (EFI_STATUS)CS_To_SignatureCollection_JSON (*((EFI_REDFISH_SIGNATURECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
