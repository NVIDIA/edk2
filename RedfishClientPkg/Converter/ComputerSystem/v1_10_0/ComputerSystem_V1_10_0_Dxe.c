...
)
{
  ...
  return (EFI_STATUS)CS_To_ComputerSystem_V1_10_0_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_10_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
