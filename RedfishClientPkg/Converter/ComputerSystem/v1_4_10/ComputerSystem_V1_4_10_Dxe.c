...
)
{
  ...
  return (EFI_STATUS)CS_To_ComputerSystem_V1_4_10_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_4_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
